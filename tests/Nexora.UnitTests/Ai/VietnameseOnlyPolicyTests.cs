...
public sealed class VietnameseOnlyPolicyTests
{
    ...
    public void PromptSchemaAndRubricVersionsAreExplicit()
    {
        ...
        Assert.Equal("interview-eval-v11", AiOperations.InterviewEvaluate.PromptVersion);
        Assert.Equal("interview-report-v5", AiOperations.InterviewReport.PromptVersion);
        ...
        Assert.Equal("interview-eval-v7", AiOperations.InterviewEvaluate.SchemaVersion);
        Assert.Equal("rubric-v2", AiOperations.InterviewEvaluate.RubricVersion);
        Assert.Equal("interview-report-v3", AiOperations.InterviewReport.SchemaVersion);
