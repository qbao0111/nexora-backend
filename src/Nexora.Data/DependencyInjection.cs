...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddDataPersistence(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IInterviewFlowService, InterviewFlowService>();
        ...
        services.AddScoped<IPracticeDashboardService, PracticeDashboardService>();
        services.AddScoped<InterviewStartJobHandler>();
        services.AddScoped<InterviewQuestionPlanJobHandler>();
        services.AddScoped<InterviewAnswerEvaluationJobHandler>();
        services.AddScoped<InterviewReportJobHandler>();
        services.AddScoped<PracticeJobProcessor>();
        ...
        services.AddScoped<IPracticeJobProcessor>(provider => provider.GetRequiredService<PracticeJobProcessor>());
