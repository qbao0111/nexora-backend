    ...
    private static void ConfigureScenarioStar(ModelBuilder builder)
    {
        builder.Entity<ScenarioCategory>(entity =>
        {
            ...
            entity.HasData(
                ...
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-000000000004"), Slug = "backend", Name = "Backend", Description = "Tình huống phát triển API, dịch vụ backend, tích hợp hệ thống và xử lý lỗi phía máy chủ.", SortOrder = 3, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-000000000005"), Slug = "frontend", Name = "Frontend", Description = "Tình huống phát triển giao diện web, state management, UX, hiệu năng và tích hợp API.", SortOrder = 4, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-000000000006"), Slug = "dotnet", Name = ".NET / C#", Description = "Tình huống thực tế với C#, ASP.NET Core, Entity Framework Core và hệ sinh thái .NET.", SortOrder = 5, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-000000000007"), Slug = "java", Name = "Java / Spring Boot", Description = "Tình huống phát triển hệ thống backend bằng Java, Spring Boot, JPA và hệ sinh thái JVM.", SortOrder = 6, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-000000000008"), Slug = "database", Name = "Database & Data", Description = "Tình huống thiết kế dữ liệu, SQL, transaction, hiệu năng truy vấn và tính toàn vẹn dữ liệu.", SortOrder = 7, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-000000000009"), Slug = "devops", Name = "DevOps / Cloud", Description = "Tình huống CI/CD, Docker, cloud, deployment, monitoring và vận hành hệ thống.", SortOrder = 8, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-00000000000a"), Slug = "qa-testing", Name = "QA / Testing", Description = "Tình huống kiểm thử phần mềm, automation test, regression, chất lượng release và xử lý bug.", SortOrder = 9, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-00000000000b"), Slug = "mobile", Name = "Mobile Development", Description = "Tình huống phát triển ứng dụng mobile, API integration, lifecycle, offline state và release app.", SortOrder = 10, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-00000000000c"), Slug = "software-architecture", Name = "Software Architecture", Description = "Tình huống thiết kế hệ thống, scalability, service boundaries và lựa chọn kiến trúc.", SortOrder = 11, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt },
                new ScenarioCategory { Id = Guid.Parse("40000000-0000-0000-0000-00000000000d"), Slug = "app-security", Name = "Application Security", Description = "Tình huống bảo mật ứng dụng dành cho lập trình viên: authentication, authorization, data exposure và secure coding.", SortOrder = 12, IsActive = true, CreatedAt = createdAt, UpdatedAt = createdAt });
        });
