...
namespace Nexora.Data.Persistence.Migrations
{
    ...
    [Migration("20260924175154_PublicSiteContentAndOrderHistory")]
    partial class PublicSiteContentAndOrderHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nexora.Data.Site.SiteAsset", b =>
                {
                    ...
                    b.ToTable("site_assets", (string)null);
                });

            modelBuilder.Entity("Nexora.Data.Site.SitePage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DraftAboutJson")
                        .HasMaxLength(30000)
                        .HasColumnType("character varying(30000)");

                    b.Property<string>("DraftBodyMarkdown")
                        .HasMaxLength(30000)
                        .HasColumnType("character varying(30000)");

                    b.Property<DateTimeOffset?>("DraftEffectiveAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("PublishedAboutJson")
                        .HasMaxLength(30000)
                        .HasColumnType("character varying(30000)");
                    ...
                    b.Property<string>("PublishedBodyMarkdown")
                        .HasMaxLength(30000)
                        .HasColumnType("character varying(30000)");

                    b.Property<DateTimeOffset?>("PublishedEffectiveAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("site_pages", (string)null);
                });

            modelBuilder.Entity("Nexora.Data.Site.SiteSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("MadeInVietnamEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("SupportAvailabilityEnabled")
                        .HasColumnType("boolean");
