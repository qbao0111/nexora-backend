...
- File: `IStorageProvider`; development dùng `LocalStorageProvider` hoặc development adapter, production dùng private object storage với signed URL. Vendor production thuộc DEC-04.
