...
- Production fail-closed: internal-development Gemini/DeepSeek AI, Fake Payment and Local Storage/upload capabilities cannot be enabled in Production. They must remain feature-disabled until DEC-01, DEC-02 and DEC-04 approve the corresponding production capabilities.
