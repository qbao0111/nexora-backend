...
- Production fail-closed: internal-development Gemini/DeepSeek AI, Fake Payment and Local Storage/upload capabilities cannot be enabled in Production. `R2StorageProvider` is accepted only with validated private R2 configuration; DEC-01, DEC-02, DEC-03 and DEC-04 still gate the corresponding production enablement.
